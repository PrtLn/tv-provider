(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('transactions', {
				url: "/transactions",
				templateUrl: viewsPrefix + "transactions.html",
				data: {
			...
			.state('clients',{
	        url:'/clients',
	        templateUrl: viewsPrefix + 'clients.html',
	        controller:'ClientListController'
	    }).state('viewClient',{
	       url:'/clients/:id/view',
	       templateUrl: viewsPrefix + 'client-view.html',
	       controller:'ClientViewController'
	    }).state('newClient',{
	        url:'/clients/new',
	        templateUrl: viewsPrefix + 'client-add.html',
	        controller:'ClientCreateController'
	    }).state('editClient',{
	        url:'/clients/:id/edit',
	        templateUrl: viewsPrefix + 'client-edit.html',
